...
sh $SERVER1_HOME/bin/standalone.sh --server-config=standalone-ha.xml -b 127.0.0.1 -bmanagement=127.0.0.1 > $LOG/lb-b2bua-early-failover-port-1-jboss.log 2>&1 &
export NODE1_PID="$!"
...
sh $SERVER2_HOME/bin/standalone.sh --server-config=standalone-ha.xml -b 127.0.0.2 -bmanagement=127.0.0.2 > $LOG/lb-b2bua-early-failover-port-2-jboss.log 2>&1 &
export NODE2_PID="$!"
